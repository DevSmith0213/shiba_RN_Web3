  ...
  return (
    <ScreenWrapper>
      ...
      <div style={{ alignItems: 'center', justifyContent: 'center', width: '100%', display: 'flex', }}>
        <OutlineButton><a href="#footer">Get your unique one-of-a-kind SOLGhost today</a></OutlineButton>
      </div>
      <Title id="loadMap" style={{ width: '90%', textAlign: 'center', marginLeft: '5%' }}>LAUNCH ROADMAP</Title>
      <ImageContainer1 url={20} first={true} last={false} title="$10,000 Shiba Charity Donation" description="Many Sol Ghost Inus died in bombing raids during World War II and it was due to a small number of dog lovers that acted to save their amazing breed from extinction. Here at Sol Ghost Society, we will continue to support their legacy by donating $10,000 to a trusted and transparent Sol Ghost Inu breeder, to commend their efforts in breeding for the community." />
      ...
      <ImageContainer1 url={60} first={false} last={false} title="Limited Release SOLGhostS" description={["Work will commence for the design and release of a small batch of limited release SOLGhostS. We have many in the works, already, but ultimately the themes such as pop culture, memes, sports, etc. will be decided by our ", <a target="_blank" href="https://discord.gg/d9K7FXF4YB">Discord</a>, " community and only owners of a SOLGhost will have a chance at purchasing these limited releases."]} />
      <ImageContainer1 url={80} first={false} last={false} title="2nd Generation SOLGhostS" description="A project team will be established for the design, development and implementation of the 2nd generation SOLGhostS. This will include all the appropriate documentation including a White Paper, breeding instructions etc. We will reward early adopters whilst slowly increasing the number of SOLGhost owners too!" />
      <ImageContainer1 url={100} first={false} last={true} title="$30,000 Successful Launch Giveaway!" description="Launch success! To reward our early adopters, a random selection of 30 SOLGhostS will be airdropped, with $1000 worth of ETH each into their owner's wallets. The more SOLGhostS you own, the higher your chances of winning the giveaway! Now, off to the moon Sol Ghost Society!" />
      <MintArea />
      <ImageContainer2 title="FAIR DROP" description1="No whitelists, no free airdrops, no pricing tiers, even us founders get none." description2="All 1st generation SOLGhostS will be all sold at a price of 0.068 ETH." description3={["All future releases will be voted by our community on our ", <a target="_blank" href="https://discord.gg/d9K7FXF4YB">Discord</a>, " and announced via", <a style={{ color: '#004aad' }} target="_blank" href="">Twitter.</a>]} />
